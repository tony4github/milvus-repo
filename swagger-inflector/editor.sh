...
# '-Dconfig=editor/inflector.yaml' is required. And, i believe 'editor/' is a URL path, not a physical folder during assembling. 
#air@Tony webapp-runner % pwd
#/Users/milvus-workspace/webapp-runner
#air@Tony webapp-runner % java -Dconfig=editor/inflector.yaml -jar assembly/target/webapp-runner.jar /Users/milvus-workspace/swagger.io/swagger-inflector/editor/swagger-editor.war
