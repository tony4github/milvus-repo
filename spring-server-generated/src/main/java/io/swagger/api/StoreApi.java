...
public interface StoreApi {
    ...
    @Operation(summary = "Find purchase order by ID", description = "whatever! For valid response try integer IDs with value <= 5 or > 10. Other values will generate exceptions.", tags={ "store" })
    @ApiResponses(value = { 
